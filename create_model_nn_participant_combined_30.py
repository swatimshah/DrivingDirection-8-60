...
model=Sequential()
model.add(Conv1D(filters=60, kernel_size=5, kernel_regularizer=L2(0.0005), bias_regularizer=L2(0.0005), activity_regularizer = L2(0.0005), kernel_constraint=min_max_norm(min_value=-0.6, max_value=0.6), padding='valid', activation='relu', strides=1, input_shape=(64, 30)))
model.add(AveragePooling1D(pool_size=3)) 
model.add(Conv1D(filters=60, kernel_size=5, kernel_regularizer=L2(0.0005), bias_regularizer=L2(0.0005), activity_regularizer = L2(0.0005), kernel_constraint=min_max_norm(min_value=-0.6, max_value=0.6), padding='valid', activation='relu', strides=1))
model.add(AveragePooling1D(pool_size=3))
model.add(Conv1D(filters=20, kernel_size=5, kernel_regularizer=L2(0.0005), bias_regularizer=L2(0.0005), activity_regularizer = L2(0.0005), kernel_constraint=min_max_norm(min_value=-0.6, max_value=0.6), padding='valid', activation='relu', strides=1))
model.add(GlobalMaxPooling1D())
model.add(Dense(40, kernel_regularizer=L2(0.0005), bias_regularizer=L2(0.0005), activity_regularizer = L2(0.0005), kernel_constraint=min_max_norm(min_value=-0.6, max_value=0.6), activation='relu'))
model.add(Dense(3, activation='softmax'))

model.summary()

# Compile the model   
adam = Adam(learning_rate=0.000065)
